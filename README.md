Console.WriteLine("Oi, meu nome é otávio ainda não sou maior de idade mas quero aprender programação para entar entrar no mercado de trabalho"); // Apresentação e interesses com a programação
